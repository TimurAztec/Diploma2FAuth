export namespace GlobalConstants {
    ...
    export class Permissions {
        ...
        public static readonly CREATE_SCHEDULE: string = "create_schedule";
        public static readonly CREATE_STAFF: string = "create_staff";
        public static readonly CREATE_ROLES: string = "create_roles";
        public static readonly CREATE_INVENTORY: string = "create_inventory";
        public static readonly CREATE_CLIENTS: string = "create_clients";
